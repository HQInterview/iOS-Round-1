...
//    NSError *error;
//    NSData *filePathData = [[NSData alloc] initWithContentsOfFile:filePath];
//    
//    NSDictionary *jsonDictionary = [NSJSONSerialization JSONObjectWithData:filePathData options:NSJSONReadingAllowFragments error:&error];
